...
void addMedicine() {
    ...
    gotoxy(30, 10); printf("通用名: "); safeInput(m->commonName, 22, 38, 10);
    gotoxy(30, 12); printf("商品名: "); safeInput(m->tradeName, 22, 38, 12);
    gotoxy(30, 14); printf("别名: "); safeInput(m->alias, 20, 36, 14);
